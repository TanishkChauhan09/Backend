...
function RandomQuestion(){
    ...
    // RANDOMLY SORT KRENGE ISKO HMMM AAJ
    // iski time comp. O(nlogn) hogi joki upar waale while loop se bhi bekar hai jiski O(n) time comp. hoti hai
    ...
    for(let i=0;i<5;i++)
    {
        ...
        // swap
        // [arr[index],arr[length-1]] = [arr[length-1],arr[index]]; //***********I FOUND THE BUG/ERROR HERE BY MYSELF or****** mistake ye hai ke arr me thodi swap krna hai questionBank me swap krna hai*/
        // arr.reverse(arr[index],arr[length-1]);//iss se bhi error shi hogyi hai
...
problem.forEach((obj,index)=>{
    ...
    obj['options'].forEach((data)=>{
        ...
        // input ke aage wala is not a innerHTML of input it's a seperate text field
...
// ********************Form checking wala code already likh chuka hoon******************************************************************
